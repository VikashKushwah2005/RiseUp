...
export default function Navbar({ navigate, onLogout, isLoggedIn }) {
  ...
  return (
    <nav className="bg-white/80 backdrop-blur-md shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        <button onClick={() => navigate('landing')} className="text-2xl font-bold text-amber-600 hover:text-amber-700 transition">Rise Up</button>
        <div className="hidden md:flex items-center space-x-6">
          <button onClick={() => navigate('home')} className="text-stone-600 hover:text-amber-600 transition">Home</button>
